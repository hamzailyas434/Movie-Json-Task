const data=[
    ...
    "imgPath": "assets/img/covers/civilwar.jpg",
    "duration": 148,
    "genre": [
    "Action",
    "Adventure"
    ...
    "imgPath": "assets/img/covers/MoneyMonster.jpg",
    "duration": 99,
    "genre": [
    "Thriller"
    ],
    ...
    "imgPath": "assets/img/covers/24.jpg",
    "duration": 163,
    "genre": [
    "Thriller"
    ],
    ...
    "imgPath": "assets/img/covers/bad.jpg",
    "duration": 110,
    "genre": [
    "Comedy"
    ],
    ...
    "description": "The Jungle Book - is an all-new live-action epic adventure about Mowgli (newcomer Neel Sethi), a man-cub raised in the jungle by a family of wolves, who embarks on a captivating journey of self-discovery when he’s forced to abandon the only home he’s ever known.",
    "imgPath": "assets/img/covers/Disney.jpg",
    "duration": 106,
    "genre": [
    "Adventure",
    "Fantasy"
    ...
    "imgPath": "assets/img/covers/azhar.jpg",
    "duration": 130,
    "genre": [
    "Sports",
    "Biopic"
    ...
    "description": "A sequel to the 2001 movie - My Sassy Girl - Gyun-woo can't forget the sassy girl. One day he meets the love of his life again and marries her. However, he goes through a honeymoon which no man would ever dream of...",
    "imgPath": "assets/img/covers/mynew.jpg",
    "duration": 100,
    "genre": [
    "Romance",
    "Comedy"
    ...
    "description": "Tang Wei plays the role of Xiao Ye a lonely gal who immigrated to Macau with her father since she was 15 years old. The casino has become like home to her. She meets Daniel, portrayed by Wu Xiubo, a real estate broker and father of teenage son. The story talks about two people who exchanged letters to each other sharing their most personal and intimate self in each of those letter. They fall in love and finds solace in each other.",
    "imgPath": "assets/img/covers/findingmrright.jpg",
    "duration": 110,
    "genre": [
    "Romance"
    ],
    ...
    "id": 20,
    "name": "Before I Wake",
    "description": "In this creepy and terrifying thriller, Cody's new foster parents Jessie and Mark can't wait to welcome the special little boy into their home. Once he settles in, Jessie and Mark soon discover Cody has a very unique gift - his vibrant and imaginative dreams come to life all around him while he is sleeping. When the curious new parents begin to cultivate this strange phenomenon by lulling Cody into deep sleep, they find that the creatures of his darkest nightmares will also come alive, wrecking havoc in the night.",
    "imgPath": "assets/img/covers/beforeiwake.jpg",
    "duration": 97,
    "genre": [
    "Horror"
    ],
    ...
    "id": 23,
    "name": "Friend Request",
    "description": "Laura, a popular college girl, is very active on social media and shares almost everything in her life with her 800+ friends on Facebook. However after accepting a friend request from an unknown girl named Marina, Laura becomes obsessed with Marina's profile, and soon her friends begin to die violently one by one",
    "imgPath": "assets/img/covers/friendrequest.jpg",
    "duration": 93,
    "genre": [
    "Horror"
    ],
    ...
    "id": 24,
    "name": "Criminal",
    "description": "The story of the right man in the wrong body. In a last-ditch effort to stop a diabolical plot, a dead CIA operative’s memories, secrets, and skills are implanted into an unpredictable and dangerous death-row inmate in hopes the he will complete the operative’s mission",
    "imgPath": "assets/img/covers/criminal.jpg",
    "duration": 113,
    "genre": [
    "Action', 'Drama"
    ],
    ...
    "imgPath": "assets/img/covers/zootopia.jpg",
    "duration": 109,
    "genre": [
    "Animation",
    "Comedy"
